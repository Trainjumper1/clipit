...
def do_init(args):
    ...
    drawer = PixelDrawer(args.learning_rate, args.pixel_size, init_image=init_image, scale=args.scale)
...
def setup_parser():
    ...
    vq_parser.add_argument("-lr",   "--learning_rate", type=float, help="Learning rate", default=0.02, dest='learning_rate')
